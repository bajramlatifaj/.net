<%@ Page Language="C#" AutoEventWireup="true" CodeFile="songDetalis.aspx.cs" Inherits="SongDetalis" %>
                ...
                <main class="discovery--section">
                    ...
                    <section class="standard--holder">
                        ...
                        <ul id="playlist" class="song-list mod-new mod-menu" runat="server" >
                            <asp:Repeater runat="server" ID="songDetalis">
                            <ItemTemplate>
                            <li class="song-list--item media-player--row">
                                ...
                                <div class="song-list--item--right">
                                    ...
                                    <a href="#" class="song-list--item--primary"><%#Eval("title") %></a>
